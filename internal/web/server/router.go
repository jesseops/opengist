...
func (s *Server) registerRoutes() {
...

	{
		...
		sB := r.SubGroup("/admin-panel")
		{
			...
			sB.GET("/create-users", admin.AdminCreateUsers)
			sB.POST("/create-users", admin.AdminCreateUserProcess)
			sB.POST("/create-users/bulk", admin.AdminCreateUsersBulkProcess)
